...
class WarrantyCheck:
    ...
    def over20Submit(self):
        ...
        description = self.driver.find_elements_by_css_selector('#sortedWarrantyResultsPlaceholder > div > div > div > div.warrantyResultsTable.hidden-sm > table:nth-child(1) > tbody > tr > td.col-lg-16')
            #sortedWarrantyResultsPlaceholder > div > div > div > div.warrantyResultsTable.hidden-sm > table:nth-child(2) > tbody > tr > td:nth-child(4) > table > tbody > tr:nth-child(1) > td"
        warrantyType = self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(1)")
        serviceTypeOne = self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(1)")
        startDateServiceOne = self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(3) > table > tbody > tr:nth-child(1)")
        endServiceOne= self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(4) > table > tbody > tr:nth-child(1)")
        statusOne= self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(5) > table > tbody > tr:nth-child(1)")
        serviceTypeTwo= self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(2) > table > tbody > tr:nth-child(2)")
        startDateServiceTwo = self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(3) > table > tbody > tr:nth-child(2)")
        endServiceTwo= self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(4) > table > tbody > tr:nth-child(2)")
        statusTwo= self.driver.find_elements_by_css_selector("div.warrantyResultsTable > table:nth-child(2) > tbody > tr > td:nth-child(5) > table > tbody > tr:nth-child(2)")
           
        with open('warranty_results.json', 'a+') as f:
            products = []
            try:
            ...
            for entry in range(0, len(description) - 1):
                ...
                print(f'counter :::{self.entries_count} ')
                i=0
                ...
                dict1[f'Device: {self.entries_count}']= product
                  
                print(f'diiiiicc{dict1}')
                #print(dict1)
